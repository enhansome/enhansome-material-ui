# Awesome material ui with stars
...
[<p align="center"><img src="https://awesome.re/badge.svg" height=20></p>](https://github.com/sindresorhus/awesome) ⭐ 504,790 | 🐛 106 | 📅 2026-09-02
...
* [Create Material-UI Theme](https://github.com/react-theming/create-mui-theme) ⭐ 90 | 🐛 3 | 🌐 JavaScript | 📅 2018-07-28 - Online tool for creating Material-UI themes via Material Design Color Tool.
...
* [Components Extra](https://github.com/alexandre-lelain/components-extra) ⭐ 89 | 🐛 11 | 🌐 TypeScript | 📅 2023-01-27 - Provides a set of "molecule" components built on top of Material-UI such as a Footer, a CookiesBanner, a BackToTop button and other complex elements highly customizable to help developers build the macro parts of their UI very quickly. Those components are often duplicated across sites - this library solves this exact problem.
* [Eslint: detect unused classes](https://github.com/jens-ox/eslint-plugin-material-ui-unused-classes) ⭐ 31 | 🐛 3 | 🌐 JavaScript | 📅 2023-03-17 - ESLint plugin to detect unused styling classes with `@mui/styles`.
...
* [mui-treasury](https://github.com/siriwatknp/mui-treasury) ⭐ 2,443 | 🐛 39 | 🌐 TypeScript | 📅 2026-05-22 - A collection of ready-to-use components based on Material-UI.
...
* [Redux-Form-Material-UI](https://github.com/erikras/redux-form-material-ui) ⭐ 823 | 🐛 72 | 🌐 JavaScript | 📅 2023-01-12 - Wrapper components to facilitate using Material-UI with Redux Form.
...
* [Material-UI Dropzone](https://github.com/Yuvaleros/material-ui-dropzone) ⭐ 478 | 🐛 108 | 🌐 JavaScript | 📅 2024-03-13 - Material-UI component built on top of react-dropzone.
...
* [Serverless Permission Policy Generator](https://github.com/Open-SL/serverless-permission-generator) ⭐ 46 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-17 - An Online Application to generate AWS IAM permissions required for deploying a Serverless stack.

## Boilerplates

A list of starter projects and boilerplates built with Material-UI Design.

* [Create React App example (mui-org/material-ui)](https://github.com/mui-org/material-ui/tree/master/examples/create-react-app) ⭐ 99,029 | 🐛 1,462 | 🌐 JavaScript | 📅 2026-09-10 - Create React App example from official Material-UI repo.
* [Saas](https://github.com/async-labs/saas) ⭐ 4,510 | 🐛 20 | 🌐 TypeScript | 📅 2025-03-21 - Boilerplate for building your own SaaS product; built with TypeScript, React, Express, Material-UI.
...
* [Create-react-app-material-ui](https://github.com/katopz/create-react-app-material-ui) ⚠️ Archived - Simple Create React App with Material-UI form submit example.

## Contributing

Your contributions are always welcome! [Click Here to read the guidelines](https://github.com/nadunindunil/awesome-material-ui/blob/master/contributing.md) ⭐ 272 | 🐛 1 | 📅 2024-08-28.
